...
/**
 * Text that uses in Dragon Tiger Game.
 *
 * @author Pitchapa Sae-lim
 */
public class GameText {
    /**
     * Message that shows how to play.
     */
    String msgHowToPlay = "      First, you should bet on Dragon or Tiger or Draw. Then, Mod enter the amount of chips that you wants to bet. After that, click the confirm and opens the card.\n" +
            "\n" +
